...
<style type="text/css">
  ...
  <body>
    ...
    <form action="<c:url value='/admin/AdminAddBookServlet' />" method="post" enctype="multipart/form-data">
    	图书名称：<input style="width: 150px; height: 20px;" type="text" name="bname" value="${requestScope.book.bname }"/><br/>
    	图书图片：<input style="width: 223px; height: 20px;" type="file" name="image"/><br/>
    	图书单价：<input style="width: 150px; height: 20px;" type="text" name="price" value="${requestScope.book.price }"/><br/>
    	图书作者：<input style="width: 150px; height: 20px;" type="text" name="author" value="${requestScope.book.author }"/><br/>
